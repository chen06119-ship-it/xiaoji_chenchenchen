...
export const duckProfile = {
  ...
  intro:
    "这是一只在路边被捡到的黄毛小鸭子的成长记录。每一次进食、休息、换羽和学会新本领，都在这里被轻轻收好。",
};
...
export const duckEntries: DuckEntry[] = [
  {
    ...
    notes: [
      ...
      "这一页可以继续补充：当时在哪里、天气怎么样、你们是怎么决定把它带回来的。",
    ],
  },
  {
    id: "picked-up",
    ...
    notes: [
      ...
      "后面可以在这里写下它刚到 303 的反应、有没有叫、有没有害怕。",
    ],
  },
  {
    id: "day-two",
    ...
    title: "第二天的小黄团",
    summary:
      "第二天的小鸡看起来更精神了一些，开始适应新的环境，也开始被大家认真记挂着。",
    stage: "适应 303",
  ...
  },
  {
    ...
    notes: [
      ...
      "如果之后加入评论功能，这条记录下面可以放独立评论区，让朋友围绕这一天留言。",
    ],
  },
  {
    id: "food-closeup",
